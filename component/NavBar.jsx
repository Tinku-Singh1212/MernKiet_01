...
const Navbar = () => {
  ...
  <div className="container-fluid">
    <NavLink className="navbar-brand text-danger" to="/">KIETMCA</NavLink>
    ...
    <div className="#" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink className="nav-link" to="/Languages"style={({ isActive }) => (isActive ? { color: "yellow", fontWeight: "bold" } : 
          { color: "red" })}>LANGUAGES</NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="nav-link" to="/Message"style={({ isActive }) => (isActive ? { color: "yellow", fontWeight: "bold" } : 
          { color: "red" })}>Message</NavLink>
        </li>
        <li className="nav-item">
